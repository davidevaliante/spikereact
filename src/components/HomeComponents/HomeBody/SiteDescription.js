...
const SiteDescription = (props) => (
    <div>
        <Responsive as={Container} minWidth={736} fluid>
        ...
        <Responsive as={Container} className="home-bg" text maxWidth={736}>
            <div className="home-text">
                <h2>Sono giochi di fortuna o anche di abilità?</h2>
                <p>La <a href={url}>legge</a> che regolamenta le <strong>awp</strong> stabilisce che oltre al 
                fattore aleatorio, in minima parte l’esito di una partità può dover dipendere anche dall’abilità 
                del giocatore.</p>
                <p>Ovviamente ci sono slot machine in cui questa componente di abilità <strong>conta in misura 
                maggiore</strong>, altre dove è irrilevante.</p>
                <p style={{ width: '100%' }}>In questo sito troverai i migliori consigli ed i bonus più 
                convenienti per trasformare la tua passione in <strong>guadagno</strong></p>
            </div>
        </Responsive>
    </div>
)
