 ...
 * Slack.
 */
exports.githubWebhook = functions.https.onRequest((req, res) => __awaiter(this, void 0, void 0, function* () {
    const cipher = 'sha1';
    ...
    try {
        yield postToSlack(req.body.compare, req.body.commits.length, req.body.repository);
        return null;
    }
    catch (error) {
        console.error(error);
